...
class DataProcessor(TorchDataset):
    ...
    def get_data(self):
        ...
        data = load_dataset(self.config["data"]["path"])
        
        data['valid'] = Dataset.from_dict(data['train'][20000:20500])
        data['train'] = Dataset.from_dict(data['train'][:500])
